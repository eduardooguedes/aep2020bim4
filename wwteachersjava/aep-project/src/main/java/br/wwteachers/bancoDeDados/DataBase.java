...
public class DataBase {
    ...
    public void createTables() {    
        try{
            ...
            // Statement createTablePostagem = conexão.createStatement();
            ...
            // createTablePostagem.close();
            System.out.println(cont++);

            // Statement createTable_disciplina_postagem = conexão.createStatement();
            ...
            // createTable_disciplina_postagem.close();
            System.out.println(cont++);

            // Statement createTableGrupo = conexão.createStatement();
            ...
            // createTableGrupo.close();
            System.out.println(cont++);

            // Statement createTable_postagem_grupo = conexão.createStatement();
            ...
            // createTable_postagem_grupo.close();
            System.out.println(cont++);

            // Statement createTable_moderadores_grupo = conexão.createStatement();
            ...
            // createTable_moderadores_grupo.close();
            System.out.println(cont++);

            // Statement createTable_participantes_grupo = conexão.createStatement();
            ...
            // createTable_participantes_grupo.close();
            System.out.println(cont++);

            // Statement createFunctionSenhaHash = conexão.createStatement();
